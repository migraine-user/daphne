        ...
        for (size_t n : {1024, 2048, 4096}) {                                                                          \
            for (int seed = 0; seed < 10; seed++) {                                                                    \
                ...
                {                                                                                                      \
                    ...
                    aggRowAnalysisAcc<DTRes, DTArg, AnalysisFlags<__VA_ARGS__>>(opcode, res, arg, nullptr);            \
...
TEST_CASE("AggRowAnalysisAcc Benchmark", "[AnalysisAccBench][AggRowAnalysisAccBench]") {
    std::ofstream csv("/tmp/benchmark/AggRowAnalysisAcc.csv");
